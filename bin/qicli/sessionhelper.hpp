...
public:
  ...
  ~SessionHelper();
  void showServicesInfoPattern(const std::vector<std::string> &patternVec, bool verbose=false, bool showHidden=false);
...
private:
  void showServiceInfo(const qi::ServiceInfo &infos, bool verbose=false, bool show_hidden=false);
