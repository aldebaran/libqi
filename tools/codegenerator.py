...
if __name__ == "__main__":
    ...
    generate_file("../qi/functors/detail/memberfunctor.hxx.in"    , "../qi/functors/detail/memberfunctor.hxx"    , 7)
    generate_file("../qi/functors/detail/voidmemberfunctor.hxx.in", "../qi/functors/detail/voidmemberfunctor.hxx", 7)
    generate_file("../qi/functors/detail/functor.hxx.in"          , "../qi/functors/detail/functor.hxx"          , 7)
    generate_file("../qi/functors/detail/voidfunctor.hxx.in"      , "../qi/functors/detail/voidfunctor.hxx"      , 7)
