...
extern "C"
{
  ...
  QIC_API unsigned int         qi_object_builder_register_event(qi_object_builder_t *object, const char *name, const char *signature);
  QIC_API unsigned int         qi_object_builder_register_property(qi_object_builder_t *object, const char *name, const char *signature);
