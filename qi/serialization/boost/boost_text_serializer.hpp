...
*/
#ifndef   __QI_SERIALIZATION_BOOST_BOOST_TEXT_SERIALIZER_HPP__
#define   __QI_SERIALIZATION_BOOST_BOOST_TEXT_SERIALIZER_HPP__

#include <string>

namespace qi {
  namespace serialization {
    class BoostTextSerializer {
    public:
...
// implementation
#include <qi/serialization/boost/boost_text_serializer.hxx>

#endif // __QI_SERIALIZATION_BOOST_BOOST_TEXT_SERIALIZER_HPP__
