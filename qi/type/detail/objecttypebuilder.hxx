...
namespace qi {
  ...
  template<typename A>
  typename std::enable_if<typename detail::Accessor<A>::is_accessor, SignalBase*>::type
  ...
  template<typename A>
  typename std::enable_if<typename detail::Accessor<A>::is_accessor, PropertyBase*>::type
