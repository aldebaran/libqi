...
namespace AL
{
  ...
  public:
    ...
    void call(const AL::Messaging::CallDefinition &params, AL::Messaging::ResultDefinition& result) {
      ...
      result.value((*fFunction)(params.args()[0].as<P0>()));
    };
  ...
  public:
    ...
    void call(const AL::Messaging::CallDefinition &params, AL::Messaging::ResultDefinition& result) {
      ...
      result.value((*fFunction)(params.args()[0].as<P0>(), params.args()[1].as<P1>()));
    };
  ...
  public:
    ...
    void call(const AL::Messaging::CallDefinition &params, AL::Messaging::ResultDefinition& result) {
      ...
      result.value((*fFunction)(params.args()[0].as<P0>(), params.args()[1].as<P1>(), params.args()[2].as<P2>()));
    };
  ...
  public:
    ...
    void call(const AL::Messaging::CallDefinition &params, AL::Messaging::ResultDefinition& result) {
      ...
      result.value((*fFunction)(params.args()[0].as<P0>(), params.args()[1].as<P1>(), params.args()[2].as<P2>(), params.args()[3].as<P3>()));
    };
  ...
  public:
    ...
    void call(const AL::Messaging::CallDefinition &params, AL::Messaging::ResultDefinition& result) {
      ...
      result.value((*fFunction)(params.args()[0].as<P0>(), params.args()[1].as<P1>(), params.args()[2].as<P2>(), params.args()[3].as<P3>(), params.args()[4].as<P4>()));
    };
