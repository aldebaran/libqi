...
#ifndef     AL_MESSAGING_DETAIL_FUNCTIONSIGNATURE_HPP_
# define     AL_MESSAGING_DETAIL_FUNCTIONSIGNATURE_HPP_
...
namespace AL {
  namespace detail {
    ...
    struct signature_function_arg_apply {
      ...
      template<typename T> void operator()(T x)    { (void) x; AL::detail::signature<T>::value(val); }
      std::string &val;
    };
    ...
    struct signature<F, typename boost::enable_if< boost::function_types::is_function<F> >::type> {
      static std::string &value(std::string &val) {
        ...
        ::AL::detail::signature< typename boost::function_types::result_type<F>::type >::value(val);
        val += ":";
...
//          AL::detail::signature<typename boost::mpl::at<ArgsType, boost::mpl::int_<i> >::type>::value(val);
//        }
        return val;
      }
    };
    ...
    struct signature<T, typename boost::enable_if< boost::function_types::is_member_function_pointer<T> >::type> {
      static std::string &value(std::string &val) {
        ...
        return AL::detail::signature<typename boost::function_types::function_type<ReturnArgsType>::type>::value(val);
      };
    };
